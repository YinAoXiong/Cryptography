...
#ifndef CRYPTOGRAPHY_AES_H
#define CRYPTOGRAPHY_AES_H
...
public:
     ...
     * @param word * w
     */
    void encrypt(byte in[4*4]);
    /**
     * 解密函数
     * @param byte * in
     * @param byte * w
     */
    void decrypt(byte in[4*4]);
};

#endif //CRYPTOGRAPHY_AES_H
